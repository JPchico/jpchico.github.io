...
export class ProjectDataShareService {
  ...
  projectsData: ProjectsData[] =[
    ...
    },
    {
      ...
      description: 'VASP is one of the most used codes in materials science, allowing for the determination of materials properties from first principles. <br> When I started in Sandvik one thing became clear, if we wanted to be able to make better predictions we needed a better system to submit, manage and store our calculations. <br> During my PostDoc in Jülich I got to hear about AiiDA and it became natural to integrate it into our way of working. <br> My journey with aiida-vasp started with asking questions and reporting issues, until I became a member of the development team, helping with bug fixes, code reviewing and introducing new features to improve the capabilities of this tool.<br> Being part of the development team not only allowed me to be able to focus on the coding aspects that were critical for us, it also put me in contact with the rest of the aiida-vasp developers, greta people that have taught me much on materials science and software development.',
